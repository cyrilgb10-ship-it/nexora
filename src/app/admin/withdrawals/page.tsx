        ...
        <header className="mb-6 flex flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-400">
              Traitez les demandes de retrait des utilisateurs.
            </p>
          </div>
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <Info
              ...
              value={`${withdrawal.amount.toLocaleString("fr-FR")} FCFA`}
            />
            ...
            <Info
              label="Total déduit"
              value={`${totalDeduction.toLocaleString("fr-FR")} FCFA`}
            />
            ...
            <Info
              label="Solde actuel"
              value={`${withdrawal.user.balance.toLocaleString("fr-FR")} FCFA`}
            />

            <Info
              label="Solde verrouillé"
              value={`${withdrawal.user.lockedBalance.toLocaleString("fr-FR")} FCFA`}
            />

            <Info
              label="Demande créée"
              value={withdrawal.createdAt.toLocaleString("fr-FR")}
            />

            {withdrawal.processedAt && (
              <Info
                label="Traitée le"
                value={withdrawal.processedAt.toLocaleString("fr-FR")}
              />
            )}
          </div>
